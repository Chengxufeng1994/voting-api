...
router.post('/api/polls/start/:id', auth, adminAuthorization, pollsController.startPoll);
router.post('/api/polls/stop/:id', auth, adminAuthorization, pollsController.stopPoll);
